...
const String START_SCANNING_RECEIPT =
    'Start by creating a receipt to split expenses effortlessly!';
...
const String DELETE_RECEIPT_MESSAGE =
    "The receipt will be permanently deleted after 30 days.";
const String PRICE = 'Price';
const String SAVE = 'Save';
const String PARTICIPANT_ALREADY_LINKED =
    'Participant already linked to this item';
