...
class Routes {
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: <RouteBase>[
      ...
      GoRoute(name: ItemsAndPeopleScreen.itemsAndPeople, path: '/itemsAndPeople', builder: (context, state) => BlocProvider(create: (context) => ItemsAndPeopleCubit(), child: ItemsAndPeopleScreen())),
