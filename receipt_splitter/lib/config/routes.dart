  ...
  static final GoRouter router = GoRouter(
    ...
    routes: <RouteBase>[
      ...
      GoRoute(
        ...
        builder:
            (context, state) => MultiBlocProvider(
              providers: [
                BlocProvider(create: (context) => ReceiptListCubit(ReceiptRepositoryImpl(DatabaseService()))..loadReceipts()),
                BlocProvider(create: (context) => FabCubit()),
                BlocProvider(create: (context) => ReceiptFormCubit(ReceiptRepositoryImpl(DatabaseService()))),
              ],
      ...
      GoRoute(
        ...
        builder: (context, state) => BlocProvider(create: (context) => ItemsAndPeopleCubit(ReceiptRepositoryImpl(DatabaseService())), child: ItemsAndPeopleScreen(receipt: state.extra as Receipt)),
      ),
      GoRoute(
        ...
        builder:
            (context, state) => MultiBlocProvider(
              providers: [BlocProvider(create: (context) => ReceiptTypeCubit()), BlocProvider(create: (context) => ReceiptFormCubit(ReceiptRepositoryImpl(DatabaseService())))],
